...
CUDA_VISIBLE_DEVICES=1 python train.py --multitask_data_path ../data/mtmrc/mt_snm/ --valid_batch_size 16 --highway_dropout 0.1 --ema_gamma 0.999 --train_datasets squad,newsqa,marco --extra_score_file nm_lm_scores.json
